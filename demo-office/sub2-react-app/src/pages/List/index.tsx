...
export default function List() {
  ...
  return (
    <IceContainer>
      ...
      >
        <Table.Column title="合同编号2" dataIndex="id" key="id" width={100} />
        <Table.Column title="合同名称2" dataIndex="name" key="name" width={100} />
        <Table.Column title="商家名称2" dataIndex="ourCompany" key="ourCompany" width={160} />
        <Table.Column title="合同金额2" dataIndex="amount" key="amount" width={100} />
        <Table.Column title="币种2" dataIndex="currency" key="currency" width={100} />
        <Table.Column
          title="合同状态2"
          dataIndex="state"
          key="state"
